...
def build_payload(note_path: str, capture_json_path: str, vault_path: str, analysis_mode: str) -> dict[str, Any]:
    ...
    payload = {
        ...
        "podcast_title": string_value(frontmatter.get("podcast_title"), capture.get("podcast_title"), metadata.get("podcast_title")),
        "podcast_author": string_value(frontmatter.get("podcast_author"), capture.get("podcast_author"), metadata.get("podcast_author")),
        "episode_url": string_value(frontmatter.get("episode_url"), capture.get("episode_url"), metadata.get("episode_url")),
        "episode_id": string_value(frontmatter.get("episode_id"), capture.get("episode_id"), metadata.get("episode_id")),
        "duration_seconds": string_value(frontmatter.get("duration_seconds"), capture.get("duration_seconds"), metadata.get("duration_seconds")),
        "summary": summary,
